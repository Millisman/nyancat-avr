...
/*
 * Initialize the UART
 * You must use expression UART_BAUD_SELECT or UART_BAUD_SELECT_DOUBLE_SPEED to set up baudrate
 */
void
uart0_init(uint16_t baudrate)
{
 ...
 *
 * The internal line buffer is RX0_BUFSIZE (80) characters long, which
 * includes the terminating \n (but no terminating \0).  If the buffer
 * is full (i. e., at RX0_BUFSIZE-1 characters in order to keep space for
